                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php
                                ...
                                if(empty($_POST['so_a']) || empty($_POST['so_b'])){
                                    $msg = 'Vui lòng nhập dữ liệu hợp lệ';
                                    $check = false;
                                }
                                else{
                                    if (!is_int($_POST['so_a']) || !is_int($_POST['so_b'])) {
                                        $msg = 'Vui lòng nhập giá trị số hợp lệ';
                                        $check = false;
                                    }
                                }

                                if (isset($_POST['dien_tich']) && $check == true) {
                        ...
                        <tr>
                            <td></td>
                            <td><input class="input-calc"  style="border: 1px solid yellow" type="text" name="msg" id="msg" disabled value="<?php echo $msg ?>"></td>
                        </tr>
                    </tbody>
                </table>
            </form>
